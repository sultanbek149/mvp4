declare global {
  const ALL_ROLES: typeof import('../../server/utils/auth').ALL_ROLES
  const DISPATCH_ROLES: typeof import('../../server/utils/auth').DISPATCH_ROLES
  const FUEL_NORM_TYPES: typeof import('../../server/utils/maintenance').FUEL_NORM_TYPES
  ...
  const MANAGE_ROLES: typeof import('../../server/utils/auth').MANAGE_ROLES
  const ROLES: typeof import('../../server/utils/auth').ROLES
  const SUPER_ONLY: typeof import('../../server/utils/auth').SUPER_ONLY
  const TO_SCHEDULE: typeof import('../../server/utils/maintenance').TO_SCHEDULE
  const __buildAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@3.21.2_d_7775f3499a3a49de1df47bee25f090a1/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').buildAssetsURL
  const __publicAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@3.21.2_d_7775f3499a3a49de1df47bee25f090a1/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').publicAssetsURL
  ...
  const calcFuelConsumption: typeof import('../../server/utils/maintenance').calcFuelConsumption
  const callNodeListener: typeof import('../../node_modules/.pnpm/h3@1.15.6/node_modules/h3').callNodeListener
  const checkMaintenanceAlerts: typeof import('../../server/utils/maintenance').checkMaintenanceAlerts
  ...
  const comparePassword: typeof import('../../server/utils/auth').comparePassword
  ...
  const defineAppConfig: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@3.21.2_d_7775f3499a3a49de1df47bee25f090a1/node_modules/@nuxt/nitro-server/dist/runtime/utils/config').defineAppConfig
  ...
  const getNormValue: typeof import('../../server/utils/maintenance').getNormValue
...
declare global {
  ...
  // @ts-ignore
  export type { ToAlert } from '../../server/utils/maintenance'
  import('../../server/utils/maintenance')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/Acer/Desktop/mvp4/node_modules/.pnpm/@nuxt+nitro-server@3.21.2_d_7775f3499a3a49de1df47bee25f090a1/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/Acer/Desktop/mvp4/node_modules/.pnpm/@nuxt+nitro-server@3.21.2_d_7775f3499a3a49de1df47bee25f090a1/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getJwtSecret, signToken, verifyToken, hashPassword, comparePassword, getTokenFromEvent, requireAuth, requireRole, ROLES, MANAGE_ROLES, SUPER_ONLY, ALL_ROLES, DISPATCH_ROLES } from 'C:/Users/Acer/Desktop/mvp4/server/utils/auth';
export { TO_SCHEDULE, checkMaintenanceAlerts, FUEL_NORM_TYPES, calcFuelConsumption, getNormValue } from 'C:/Users/Acer/Desktop/mvp4/server/utils/maintenance';
export { prisma } from 'C:/Users/Acer/Desktop/mvp4/server/utils/prisma';